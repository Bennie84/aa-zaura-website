...
//       {/* Page Header */}
//       <section className="bg-gradient-to-b from-primary to-primary/95 text-white py-32 sm:py-40">
...
//               className="text-lg sm:text-xl text-text leading-relaxed mb-8 max-w-3xl"
//             >
//               {biography.intro}
//             </motion.p>
//           </motion.div>
...
//             <motion.h2
//               variants={itemVariants}
//               className="text-4xl sm:text-5xl font-bold text-primary mb-12"
//             >
//               Early Life & Origins
//             </motion.h2>
...
//             <motion.p
//               variants={itemVariants}
//               className="text-lg text-text leading-relaxed mb-8 max-w-3xl"
//             >
//               {biography.earlyLife}
//             </motion.p>
...
//             <motion.p
//               variants={itemVariants}
//               className="text-lg text-text leading-relaxed max-w-3xl"
//             >
...
//             <motion.h2
//               variants={itemVariants}
//               className="text-4xl sm:text-5xl font-bold text-primary mb-16"
//             >
...
//                   key={index}
//                   variants={itemVariants}
//                   className="border-l-4 border-secondary pl-8 py-6 hover:bg-background transition rounded-r-lg pr-8"
//                 >
...
//                     </div>
//                     <span className="text-sm font-semibold text-white bg-secondary px-4 py-2 rounded-lg whitespace-nowrap">
//                       {edu.year}
//                     </span>
//                   </div>
//                 </motion.div>
...
//             <motion.div
//               variants={itemVariants}
//               className="mt-20 p-12 bg-secondary/5 border border-secondary/20 rounded-xl"
//             >
...
//             <motion.h2
//               variants={itemVariants}
//               className="text-4xl sm:text-5xl font-bold text-primary mb-16 text-center"
//             >
...
//               <motion.div
//                 variants={itemVariants}
//                 className="p-10 bg-white border border-border rounded-lg hover:shadow-lg transition"
//               >
//                 <div className="w-14 h-14 bg-secondary/10 rounded-lg mb-8 flex items-center justify-center">
//                   <svg
...
//             <motion.h2
//               variants={itemVariants}
//               className="text-4xl sm:text-5xl font-bold text-primary mb-10"
//             >
//               Vision & Values
//             </motion.h2>
...
//       <section className="py-28 sm:py-40 bg-primary text-white">
...
//               <Link
//                 to="/career"
//                 className="bg-secondary hover:bg-secondary/80 text-white px-10 py-4 rounded-lg font-semibold transition text-base"
//               >
//                 Career Journey
//               </Link>
//               <Link
//                 to="/philanthropy"
//                 className="border-2 border-white text-white hover:bg-white hover:text-primary px-10 py-4 rounded-lg font-semibold transition text-base"
//               >
//                 Philanthropy & Impact
//               </Link>
//               <Link
...
export default function BiographyPage() {
  ...
  return (
    <>
      ...
      {/* Page Header */}
      <section className="biography-section biography-story bg-gradient-to-b from-gray-900 to-gray-800 text-white py-24">
      ...
      <section className="biography-section biography-introduction py-24 bg-white">
        <div className="biography-story-content max-w-3xl mx-auto px-6">
          <motion.div
            variants={containerVariants}
            initial="hidden"
            whileInView="visible"
      ...
      {/* Early Life Section */}
      <section className="biography-section biography-early-life py-24 bg-gray-50">
        <div className="biography-early-content max-w-3xl mx-auto px-6">
          <motion.div
            variants={containerVariants}
            initial="hidden"
            whileInView="visible"
